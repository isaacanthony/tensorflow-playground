...
y1  = keras.layers.Conv2D(32, (5, 5), activation='relu')(in1)
y1  = keras.layers.MaxPooling2D(pool_size=(4, 4))(y1)
y1  = keras.layers.Conv2D(32, (5, 5), activation='relu')(y1)
y1  = keras.layers.MaxPooling2D(pool_size=(4, 4))(y1)

in2 = keras.layers.Input(shape=(75, 75, 1))
y2  = keras.layers.Conv2D(32, (5, 5), activation='relu')(in2)
y2  = keras.layers.MaxPooling2D(pool_size=(4, 4))(y2)
y2  = keras.layers.Conv2D(32, (5, 5), activation='relu')(y2)
y2  = keras.layers.MaxPooling2D(pool_size=(4, 4))(y2)
